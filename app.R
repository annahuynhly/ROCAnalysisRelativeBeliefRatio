...
# SECTION 3.4 #######################################################
# betaprior -> NEED TO CODE FUNCTIONS 
# BNPAUCFemales -> NEED TO CODE FUNCTIONS
# BNPAUCMales -> NEED TO CODE FUNCTIONS
# BNPcfixedMales -> CANNOT RUN; waiting for fixed bugs
# BNPcoptFemales -> NEED TO CODE FUNCTIONS
# BNPcoptMales -> NEED TO CODE FUNCTIONS
# BNPdata -> NEED TO CODE FUNCTIONS
# empiricals -> NEED TO CODE FUNCTIONS
# itsforgammaprior -> NEED TO CODE FUNCTIONS
...
ui <- navbarPage(title = " ROC Analysis & Relative Belief",
                 ...
                 navbarMenu("Section 3.3",
                            tabPanel("Variables", page_variables),
