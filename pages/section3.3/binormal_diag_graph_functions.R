...
binormal_diag_plots_AUC_copt = function(delta, priorcmoddensity = FALSE, postcmoddensity = FALSE,
  ...
  if((typeof(priorcmoddensity) == "double") & (typeof(postcmoddensity) == "double")){
    ...
    polygon(grid, postcmoddensity, col = rgb(rgb_post[1]/255, rgb_post[2]/255, rgb_post[3]/255, 
                                  alpha = transparency), border = NA)
    polygon(grid, priorcmoddensity, col = rgb(rgb_prior[1]/255, rgb_prior[2]/255, rgb_prior[3]/255, 
                                   alpha = transparency), border = NA)
    ...
    polygon(grid, RBcmod, col = rgb(rgb_rbr[1]/255, rgb_rbr[2]/255, rgb_rbr[3]/255, 
            alpha = transparency), border = NA)
  }
}
